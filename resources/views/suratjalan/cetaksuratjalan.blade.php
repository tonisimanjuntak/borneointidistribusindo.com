...
<table class="detail-transaksi" border="1" cellpadding="3" cellspacing="0" width="100%">
    <thead>
    ...
    <tbody>
        ...
        <tr class="fs-11">
            ...
            <td width="20%" style="text-align: center;">{{ $row->qty . ' ' . $row->satuan }}</td>
            <td width="70%" style="text-align: left;">{{ $row->keterangan }}</td>
        </tr>
        @endforeach

        @if ($no < 6) @for ($i=$no; $i <=6; $i++) <tr class="fs-11">
