        ...
        <table border="0" cellpadding="5" width="100%">
            <thead>
                <tr style="font-size:9px; font-weight: bold;">
                    ...
                    <th width="10%" style="text-align:center;" class="add-border-top add-border-bottom">NO
                        FAKTUR/<br>TANGGAL</th>
                    <th width="10%" style="text-align:center;" class="add-border-top add-border-bottom">
                        TANGGAL<br>DITERIMA</th>
            ...
            <tbody>
                ...
                <tr style="font-size:9px; font-weight: bold;">
                    ...
                    <td width="8%" style="text-align:right;" class="add-border-top">{{
                        format_rupiah($subtotalhargasatuan) }}</td>
                    <td width="8%" style="text-align:right;" class="add-border-top">{{ format_rupiah($subtotalhargadpp)
                        }}</td>
                    <td width="8%" style="text-align:right;" class="add-border-top">{{ format_rupiah($subtotaljumlahppn)
                        }}</td>
                    <td width="8%" style="text-align:right;" class="add-border-top">{{
                        format_rupiah($subtotaljumlahdiskon) }}</td>
                    <td width="8%" style="text-align:right;" class="add-border-top">{{ format_rupiah($totalpotongan_old)
                        }}</td>
                    <td width="8%" style="text-align:right;" class="add-border-top">{{
                        format_rupiah($subtotalsubtotalbeli - $totalpotongan_old) }}</td>
                </tr>
                @php
                $subtotalhargasatuan = 0;
                $subtotalhargadpp = 0;
                ...
                <tr style="font-size:9px;">
                    ...
                    <td width="10%" style="text-align:center;" class="add-border-top">{{ $row->nofaktur }}<br>{{
                        tgldmy($row->tglfaktur) }}</td>
                    <td width="10%" style="text-align:center;" class="add-border-top">{{ tgldmy($row->tglditerima) }}
                    </td>
                    <td width="22%" style="text-align:left;" class="add-border-top">{{
                        $row->namasupplier }}<br>{{ $row->keterangan }}</td>
                    ...
                    <td width="8%" style="text-align:right;" class="add-border-top"></td>
                    <td width="8%" style="text-align:right;" class="add-border-top">{{
                        format_rupiah($row->totalpotongan) }}</td>
                    <td width="8%" style="text-align:right;" class="add-border-top"></td>
                </tr>
                ...
                <tr style="font-size:9px; font-weight: bold;">
                    <td width="52%" style="text-align:center;" class="add-border-top add-border-bottom" colspan="5">T O
                        T A L</td>
                    <td width="8%" style="text-align:right;" class="add-border-top add-border-bottom" colspan="2">{{
                        format_rupiah($totalhargasatuan) }}</td>
                    <td width="8%" style="text-align:right;" class="add-border-top add-border-bottom" colspan="2">{{
                        format_rupiah($totalhargadpp) }}</td>
                    <td width="8%" style="text-align:right;" class="add-border-top add-border-bottom" colspan="2">{{
                        format_rupiah($totaljumlahppn) }}</td>
                    <td width="8%" style="text-align:right;" class="add-border-top add-border-bottom" colspan="2">{{
                        format_rupiah($totaljumlahdiskon) }}</td>
                    <td width="8%" style="text-align:right;" class="add-border-top add-border-bottom" colspan="2">{{
                        format_rupiah($totalpotongan) }}</td>
                    <td width="8%" style="text-align:right;" class="add-border-top add-border-bottom" colspan="2">{{
                        format_rupiah($totalsubtotalbeli - $totalpotongan) }}</td>
                </tr>
